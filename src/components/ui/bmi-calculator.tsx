...
export default function BmiCalculator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-green-100flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-[#ffa500] to-[#ff6b6b] dark:from-gray-900 dark:to-gray-800 p-4 dark:bg-gray-900">
